	...
	switch(num){
		...
		case 2:
			gpio_direction_output(pdata->en_gpio_num, 1);
        		mdelay(5);			
			rt8053_write_reg(rt8053_client, RT8053_OUTPUT_ENABLE, 0x80 | 0x20);	// 1.2V First
			mdelay(1);
...
static DEVICE_ATTR(poweronoff, 0664, 

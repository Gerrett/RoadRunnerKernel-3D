...
#define HDMI_IRQ_PHY_LINK_DISCON		0x04000000
#define HDMI_IRQ_PHY_LINK_CONNECT		0x02000000
#define HDMI_IRQ_PHY_5V_SHORT_ASSERT	0x01000000
#define HDMI_IRQ_VIDEO_FRAME_DONE		0x00020000
#define HDMI_IRQ_VIDEO_VSYNC			0x00010000
#define HDMI_IRQ_AUDIO_SAMPLE_REQ		0x00000400
#define HDMI_IRQ_AUDIO_FIFO_OVERLOW		0x00000200
#define HDMI_IRQ_AUDIO_FIFO_UNDERFLOW	0x00000100
#define HDMI_IRQ_OCP_TIME_OUT			0x00000010
#define HDMI_IRQ_CORE_INTR				0x00000001

//IRQ Related functions
void HDMI_WP_IRQ_set(u32 set);
void HDMI_WP_IRQ_unset(u32 unset);
void HDMI_WP_IRQ_get_status(u32 *wp_intr);
//void HDMI_CORE_IRQ_set(u32 set);	//later
...
int hdmi_audio_disable_wait(unsigned long miili);
